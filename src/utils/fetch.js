...
// export const APIHost ='http://127.0.0.1:2000';
export const APIHost ='http://192.168.1.167';
...
export function getAuth(url,username,password){
  ...
  var pass = AES.encrypt("/index.php"+url+":"+new Date().getTime(),key,{iv:iv,mode:CryptoJs.mode.CBC,padding:CryptoJs.pad.ZeroPadding}).toString();
